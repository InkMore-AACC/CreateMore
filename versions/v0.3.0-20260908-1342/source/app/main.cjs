...
async function start(){
  ...
  window=new BrowserWindow({width:1600,height:980,minWidth:960,minHeight:640,title:'CreateMore',icon:path.join(__dirname,'ui/assets/brand/oo-logo.ico'),backgroundColor:'#171717',show:!process.argv.includes('--smoke-test')&&!process.argv.includes('--e2e-test'),webPreferences:{preload:path.join(__dirname,'preload.cjs'),contextIsolation:true,nodeIntegration:false,sandbox:true,webSecurity:true}});
